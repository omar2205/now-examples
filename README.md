...
| [haskell-hello](https://haskell-hello-v2.now.sh) | [Haskell](https://en.wikipedia.org/wiki/Haskell_(programming_language)) | Uses the [`scotty`](https://github.com/scotty-web/scotty) framework to implement a webserver | 5.9M |
